...
import { BookCopy, BookOpen, Database, LayoutDashboard, LibraryBig, Plus, Search, Settings, X } from "lucide-react";
...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <div className="app-main">
      {page === "dashboard" && dashboard && <DashboardPage data={dashboard} onCreate={() => setCreateModal(true)} onOpenProject={openProject} />}
