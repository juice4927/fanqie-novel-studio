...
const api: AppApi = {
  ...
  listIncubations: () => invoke("listIncubations"),
  listProjectSignatures: () => invoke("listProjectSignatures"),
  getIncubation: (id) => invoke("getIncubation", id),
  saveIncubation: (draft) => invoke("saveIncubation", draft),
  deleteIncubation: (id) => invoke("deleteIncubation", id),
  ...
  generatePlanningDraft: (id, input, override) => invoke("generatePlanningDraft", id, input, override),
  ...
  getGenerationQuality: (id) => invoke("getGenerationQuality", id),
  ...
  generateChapterBatch: (id, chapterId, override) => invoke("generateChapterBatch", id, chapterId, override),
  getAiSettings: () => invoke("getAiSettings"),
  testAiConnection: (override) => invoke("testAiConnection", override),
